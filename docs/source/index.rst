...
This documentation is based on Alicebot `Docs <https://docs.alicebot.dev>`_, but with some modifications and improvements. It still has many shortcomings and is currently under reconstruction.
