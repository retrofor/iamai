---
title: IamAI - Cross-platform robot framework for Machine Learning
---
...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">Cross-platform robot framework<br className='sm:block hidden'/> for Machine Learning.</h1>
    <p className="subtitle">Mainly used with<br className='sm:block hidden'/> transformers<a className="huggingface-link" href="https://huggingface.co" target="_blank">(Know more about Transformer)</a>.</p>
