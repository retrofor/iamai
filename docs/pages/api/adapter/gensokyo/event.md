...
## _class_ `GSKEvent` {#GSKEvent}

Bases: `iamai.event.Event[GSKAdapter]`
...
### _method_ `get_event_type()` {#GSKEvent.get\_event\_type}
...
### _readonly property_ `to_me` {#GSKEvent.to\_me}
...
Bases: `iamai.adapter.gensokyo.event.GSKEvent`, `iamai.event.MessageEvent[GSKAdapter]`
...
- **Attributes**
  ...
  - **message** (_iamai.adapter.gensokyo.message.GSKMessage_)
...
- **Arguments**
  ...
  - **message** (_Union\[List\[iamai.adapter.gensokyo.message.GSKMessageSegment\], iamai.adapter.gensokyo.message.GSKMessageSegment, str, Mapping\[str, Any\]\]_) - 回复消息的内容，同 `call_api()` 方法。
...
Bases: `iamai.adapter.gensokyo.event.MessageEvent`
...
- **Attributes**
  ...
  - **anonymous** (_Optional\[iamai.adapter.gensokyo.event.Anonymous\]_)
...
Bases: `iamai.adapter.gensokyo.event.GSKEvent`
...
Bases: `iamai.adapter.gensokyo.event.NoticeEvent`
...
Bases: `iamai.adapter.gensokyo.event.NotifyEvent`
...
Bases: `iamai.adapter.gensokyo.event.RequestEvent`
...
Bases: `iamai.adapter.gensokyo.event.MetaEvent`
