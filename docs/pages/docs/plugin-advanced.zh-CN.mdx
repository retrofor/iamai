...
```python filename="plugins/test.py" showLineNumbers /self.skip()/
...
```python filename="plugins/test.py" showLineNumbers /self.stop()/
from iamai import Plugin
...
```python filename="plugins/test.py" showLineNumbers {9}
# 错误：skip() 方法不会生效
from iamai import Plugin
...
```python filename="plugins/test.py" showLineNumbers {8}
from iamai import Plugin
...
```python filename="plugins/count.py" showLineNumbers /self.state/
from iamai import Plugin
...
```python filename="plugins/global_state_test.py" showLineNumbers /self.bot.global_state/
from iamai import Plugin
...
```python filename="plugins/test_plugin.py" showLineNumbers /self.config.test_plugin/
...
```python {7} filename="plugins/test/__init__.py" showLineNumbers
from iamai import Plugin
...
```python filename="plugins/test.py" showLineNumbers /__post_init__/
from iamai import Plugin
...
```python {2,7} filename="plugins/test.py" showLineNumbers /logger/
from iamai import Plugin
...
```python filename="plugins/base_plugin.py" showLineNumbers /BasePlugin/
from abc import ABC
...
```python filename="plugins/test.py" showLineNumbers {12}
