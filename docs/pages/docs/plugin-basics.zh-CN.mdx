...
```python {4} filename="main.py" showLineNumbers
...
```python {7} filename="main.py" showLineNumbers
from iamai import Bot
...
<FileTree>
  <FileTree.Folder name="iamai-starter" defaultOpen>
    <FileTree.Folder name="plugins" defaultOpen>
      <FileTree.File name="a.py (单个 Python 文件)" />
      <FileTree.Folder name="b (Python 包)" defaultOpen>
...
```python {5-6} filename="plugins/test.py" showLineNumbers /rule(self)/ /handle(self)/
...
```python {9-13} filename="plugins/hello.py" showLineNumbers /rule(self)/
from iamai import Plugin
...
```python {6} filename="plugins/hello.py" showLineNumbers /handle(self)/
from iamai import Plugin
...
```python filename="plugins/weather.py" showLineNumbers
from iamai import Plugin
