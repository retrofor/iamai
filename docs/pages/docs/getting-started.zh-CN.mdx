...
### 试试运行 `main.py` 吧！
      ...
      ```ansi
      [35m 2021-07-24 00:00:00.000 [32m | INFO | [36m iamai.bot:_load_plugins_from_dirs:689 [37m - [32m Loading plugins from dirs "/xxx/plugins"
      [35m 2021-07-24 00:00:00.000 [32m | INFO | [36m iamai.bot:_load_adapters:746 [37m - [32m Succeeded to load adapter "CQHTTPAdapter" from "iamai.adapter.cqhttp"
      [35m 2021-07-24 00:00:00.000 [32m | INFO | [36m iamai:run:90 [37m - [32m Running iamai...
      ```
