...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">可机器学习的<br className='sm:block hidden'/>跨平台机器人框架。</h1>
    <p className="subtitle">主要适配 <br className='sm:block hidden'/>transformers<a className="huggingface-link" href="https://huggingface.co" target="_blank">(了解Transformer)</a>。</p>
