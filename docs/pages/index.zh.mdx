...
{/*
@TODO 优化i18n的样式
@BODY Nextra原来的主页太乱太复杂了，到时候需要整一个简洁又高效的 
*/}
...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">跨平台机器人+深度学习模型=<br className='sm:block hidden'/>??</h1>
    <p className="subtitle">简单的异步多后端跨平台机器人框架<br className='sm:block hidden'/>(同时支持调用、训练、评估nlp模型) <a className="huggingface-link" href="https://huggingface.co" target="_blank">了解Transformer</a>.</p>
