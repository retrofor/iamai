...
| 5. Version 1.0 contract | `IN_PROGRESS` | [#434](https://github.com/retrofor/iamai/issues/434); [v1.0-A PR #455](https://github.com/retrofor/iamai/pull/455); [merge `d67d639`](https://github.com/retrofor/iamai/commit/d67d639b1abbce9c846a63c3efc98de0cdfe3574); [post-merge CI](https://github.com/retrofor/iamai/actions/runs/29469491022); [CodeQL](https://github.com/retrofor/iamai/actions/runs/29469490546); [v1.0-B PR #456](https://github.com/retrofor/iamai/pull/456) | v1.0-B final CI pending; keep lifecycle and Context TODO items open until required checks pass |
