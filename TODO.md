...
| 5. Version 1.0 contract | `IN_PROGRESS` | [#434](https://github.com/retrofor/iamai/issues/434); v1.0-A serialization contract in progress | Complete v1.0-A before lifecycle and policy slices |
