...
| 1. FOSSA governance | `BLOCKED_EXTERNAL` | [PR #446](https://github.com/retrofor/iamai/pull/446); [baseline](docs/reference/fossa-governance-baseline.rst); [#436 latest gate recheck](https://github.com/retrofor/iamai/issues/436#issuecomment-4999175082) | Last verified 2026-07-17; FOSSA still targets `master`; resume with a Full credential or UI session granting project View/Edit and `SetPolicy` |
