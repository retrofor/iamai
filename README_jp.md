<p align="center">
<img width="128" src="https://iamai.retrofor.space/retro.png"></p>
<h1 align="center">
  iamai
</h1>
<p align="center">
...
- 👍 **クロスプラットフォーム**: [cqhttp](https://iamai.retrofor.space/guide/cqhttp-adapter.html), [dingtalk](https://iamai.retrofor.space/guide/dingtalk-adapter.html), [Mirai](https://iamai.retrofor.space/guide/mirai-adapter.html) など
...
iamai自体はただのチャットボットフレームワークであり、特定のプロトコルをサポートするために、対応するプロトコルアダプタを追加でインストールする必要があります。pipを使用して、プロトコルアダプタをインストールできます。
